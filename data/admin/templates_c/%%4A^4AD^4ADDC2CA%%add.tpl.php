<?php /* Smarty version 2.6.20, created on 2013-09-20 11:48:31
...
/product/dosave" method="post" enctype="multipart/form-data">
<input type="hidden" name="btSave" value="save"/>
<table width="100%" border="0" cellpadding="0" cellspacing="1">
	<tr class="label_title">
		<td colspan="2">&nbsp;&nbsp;Thêm mới công trình</td>
	</tr>
	<tr class="login">
...
"><?php echo $this->_tpl_vars['rRow']['category_name']; ?>
</option>
	...
	<tr class="login">
		...
		<td width="870%"><input type="text" id="txtTime_Finish" name="txtTime_Finish" class="input" maxlength="255" value="" />
		</td>
	</tr>
	<tr class="login">
