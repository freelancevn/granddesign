<?php /* Smarty version 2.6.20, created on 2013-09-11 18:21:05
...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
	...
	<tr class="login">		
		<td width="100%" colspan="2">
			Link Google: <input type="text" name="txt_linkgoogle" value='<?php echo $this->_tpl_vars['arrLink']['key_value']; ?>
' style="width:90%;"/>
		</td>
	</tr>
	<tr class="login">		
	...
	<tr class="login">		
		<td width="100%" colspan="2">
			Link Google: <input type="text" name="txt_linkgoogle2" value='<?php echo $this->_tpl_vars['arrLink2']['key_value']; ?>
' style="width:90%;"/>
		</td>
	</tr>	
	<tr class="login">		
