...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 22, 2014 at 12:03 AM
...
(3, 'http://haha.vn', 'http://haha.vn', 0, 1);
...
(5, 'CONTACTHCM', '<p>216 Nguyễn Thị Minh Khai, Q.3, Tp.HCM - 0916.979.777(Mr.Minh)</p>\r\n'),
(6, 'CONTACTHANOI', '<p>15/36 Nguyễn Viết Xu&acirc;n - H&agrave; Nội - 0985.37.3333 (Mr Hải)</p>\r\n'),
...
(13, 'SLOGAN', 'SLOGAN'),
(14, 'MISSIONANDVISION', '<p>MISSIONANDVISION</p>\r\n'),
(15, 'REGULATION', '<p>REGULATION UPDATED</p>\r\n'),
(16, 'PROCESSFLOW', '<p>PROCESSFLOW</p>\r\n');
...
CREATE TABLE IF NOT EXISTS `ktv_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `newstype` smallint(6) NOT NULL DEFAULT '1' COMMENT '1: new; 2: fengshui',
