...
<head>
    ...
    <link rel="stylesheet" href="{$smarty.const.CSS}style1.css"" media="screen">
    <!--[if lte IE 7]><link rel="stylesheet" href="style.ie7.css" media="screen" /><![endif]-->
    <link rel="stylesheetstylesheet" href="{$smarty.const.CSS}style.responsive1.css" media="all">


    <script src="{$smarty.const.JS}jquery1.js"></script>
    <script src="{$smarty.const.JS}script1.js"></script>
    <script src="{$smarty.const.JS}script.responsive1.js"></script>
