	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				...
				css: {
					lightbox:	HOST_STATIC + 'css/admin/hat/jquery.lightbox.css'
				}
			},
			uncompressed: {
				js: {
			...
			images: { 
				prev:		'../../img/admin/hat/lightbox_images/prev.gif',
				next:		'../../img/admin/hat/lightbox_images/next.gif',
				blank:		'../../img/admin/hat/lightbox_images/blank.gif',
				loading:	'../../img/admin/hat/lightbox_images/loading.gif'
			}
		},
		text: {
			// For translating
