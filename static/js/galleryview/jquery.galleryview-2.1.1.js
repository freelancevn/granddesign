	...
	*/
		function buildFilmstrip() {
			...
			$('img',j_frames).each(function(i){
				...
				//anvo: loading enhancement *
				var current_src = $(this).attr("src");
				var tmp = current_src.substr(current_src.lastIndexOf("/"));
				//current_src = current_src.replace(tmp, "/thumbs"+tmp);				
				//current_src = current_src.replace("large","small");
				current_src = current_src.replace("upload","upload_thumb");
				current_src = current_src.replace(".","_45.");
